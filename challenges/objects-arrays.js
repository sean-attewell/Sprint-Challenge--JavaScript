...
console.log(uni);
// Doesn't include lower case 'uni', in line with what the question asks
...
The zoos need a list of all their animal's names (names only, not scientific) converted to lower case.  Create a new array named lowerCase and 
map over each name to convert them all to lower case.  Log the resut.
